# Generated by Django 4.0.3 on 2022-05-02 15:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('markdown_url', models.URLField(default='https://www.github.com/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField()),
                ('description', models.TextField(blank=True, null=True)),
                ('link_type', models.IntegerField(choices=[(0, 'Supplement'), (1, 'Challenge'), (2, 'Assessment')], default=1)),
