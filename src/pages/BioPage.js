  ...
  return (
    <form onSubmit={saveUser}>
      <Row className={"mx-5 mt-4"}>
        <Col className={"pageSection primary"}>
          {" "}
          <Row>
            <Col xs={12}>
              <EditToggle />
              ...
              <div>
                <h3>
                  <strong>{userBio?.groups[0]?.name} Cohort</strong>
                </h3>
        ...
        <Col className={"pageSection secondary"} xs={5}>
          {" "}
          <Row>
            <Col className={"text-center"} xs={12}>
              <h3>
                <strong>
                  {userBio.first_name} {userBio.last_name}
                </strong>
              </h3>
              <BioImage
                canEdit={canEdit}
            ...
            <Col xs={12} className={"text-center"}>
              <h5>
                <strong>{userBio.email}</strong>
              </h5>
              <ThemeProvider theme={theme}>
                <FormControl sx={{ marginTop: "1rem" }}>
                  <InputLabel id="timezone-select">Time Zone</InputLabel>
                  <Select
                    name={"timezone"}
