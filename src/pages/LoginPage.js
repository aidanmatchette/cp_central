        ...
        <ThemeProvider theme={theme}>
            <Container component="main" maxWidth="xs">
                ...
                <Box
                    ...
                    <img src="https://www.codeplatoon.org/wp-content/uploads/2018/10/CP-logo-2018-abbrev-1.png"
                         width="200"
                         alt='cp-logo'
                    />
                ...
                <ul>
                    {logins.map((element, index) => <li key={index}
                                                        onClick={() => fillLogin(index)}>{element.username}</li>)}
                </ul>
            </Container>
        </ThemeProvider>
